...
module.exports.forgotPasswordPost = async (req, res) => {
  ...
  // Kiểm tra email đã tồn tại trong forgot-password
  ...
  // Lưu vào database: emai và OTP. Sau 5 phút sẽ tự động xóa bản ghi
...
module.exports.otpPasswordPost = async (req, res) => {
  ...
  // Kiểm tra có tồn tại bản ghi trong forgot-password
  const existReocord = await ForgotPassword.findOne({
    otp: otp,
    email: email
  })
